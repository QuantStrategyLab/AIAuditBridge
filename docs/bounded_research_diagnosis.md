...
完整输入必须是按名称排序的显式 `{name, digest}` 集合。M1 公开输入是 B0 ledger `68b96ff510bec653c2286d456b719fa680a7a731debd71b0a1bb27b4c57392ba` 与 dynamic ledger `9ab7b28d0fa9a024c389d49d4eaa3f79adae591cd100d80411f125bf03da832e`，结算政策是 `post_r9_us_equity_dtc_standard_settlement_v1` / `c135c023ee7329ad6103021ffbb79d4cdfea01e903ac331865c157a6a1246853`，策略 revision 是 `1c4a1c3118d4d482bdb7191f9b7cda40cd4955cf`。一个 raw digest 不能代替该集合，`HEAD` 也不能代替未提交 revision。缺数值结果、候选/study/revision 不符、摘要或 canonical digest 被改、结算/成本/政策不符、权限升级或非 development，都会拒绝。P1 accepted、作业完成、CI 通过、Astra GO、正收益和负收益都不产生采用或交易；负结果也不是修到盈利的指令。
