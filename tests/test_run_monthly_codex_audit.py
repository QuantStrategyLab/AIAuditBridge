...
```"""
    ...
    def test_vps_ops_workflow_runs_only_manual_self_hosted_ops(self) -> None:
        ...
        self.assertIn("Verify trusted QPK drift workflow refs", workflow)
        self.assertIn("repos/QuantStrategyLab/QuantPlatformKit/contents/.github/workflows/reusable-drift-check.yml?ref=${ref}", workflow)
    ...
    def test_vps_deploy_adds_nginx_audit_route_without_router_service(self) -> None:
        ...
        artifact_v6_qpk_job_ref = "QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@b939522701b527096e5d028346e777714466bcc5"
        ...
        self.assertIn(artifact_v6_qpk_job_ref, deploy_script)
        self.assertIn(artifact_v6_qpk_job_ref, workflow)
