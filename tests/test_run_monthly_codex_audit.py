...
```"""
    ...
    def test_vps_deploy_adds_nginx_audit_route_without_router_service(self) -> None:
        ...
        artifact_v7_qpk_job_ref = "QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@8b8ce3543c04bf12920e38b0f45d2b32a8896580"
        ...
        self.assertIn(artifact_v7_qpk_job_ref, deploy_script)
        self.assertIn(artifact_v7_qpk_job_ref, workflow)
