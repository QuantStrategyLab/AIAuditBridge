...
```"""
    ...
    def test_vps_ops_workflow_runs_only_manual_self_hosted_ops(self) -> None:
        ...
        self.assertIn("QuantStrategyLab/QuantPlatformKit/.github/workflows/reusable-drift-check.yml@644cd9002ae92f2aaca6f7efb4afa4986fae05ea", workflow)
    ...
    def test_vps_deploy_adds_nginx_audit_route_without_router_service(self) -> None:
        ...
        self.assertIn("rotate this SHA with downstream workflow pins", deploy_script)
